...
- AC3: Marketing SMS sends only with express written consent captured with TCPA-appropriate disclosure language, supports STOP/HELP keywords, and is suppressed outside 8am–9pm recipient local time. *(This PRD mandates the control; final disclosure copy requires legal review — Open Questions Q5.)*
