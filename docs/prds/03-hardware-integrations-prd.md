...
- **AC4 and `mobile_key` are B-086 part 2 and unbuilt.** `AccessCredentialType.mobile_key` has been in the enum since B-002 with no reader, no writer and no UI. OQ-2 is untouched by part 1.
