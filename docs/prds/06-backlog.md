...
| 7 | B-007 | Admin shell: left nav, global header, facility switcher with "All facilities" context, universal search stub, role-gated routes | PRD 02 §4.1 US-1, FR-1–3 | M | B-004 | MVP |
