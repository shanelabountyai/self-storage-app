...
**Entries:** 284 across 20 part files.
...
| Chore — the decision log gets an index, reversing what the split left behind | — | [20-from-b-258](progress/20-from-b-258.md#chore-the-decision-log-gets-an-index-reversing-what-the-split-left-behind) |
