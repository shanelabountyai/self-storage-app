...
export const COMMS_TEMPLATES: readonly CommsTemplateSeed[] = [
  ...
  // their email, and the dunning ladder (B-052) then has nobody listening.
  {
    ...
    bodyText: [
      ...
      '',
      'Already paid, or paying at the office? Then nothing is needed — this crossed in the mail.',
      '',
      'Questions? Call {{facility.phone}}.',
    ].join('\n'),
    es: {
  ...
  // every one of them: naming one unit out of fifteen is the confusion.
  {
    ...
    bodyText: [
      ...
      '',
      'One payment settles every unit on the account. Already paid, or paying at the office? Then nothing is needed — this crossed in the mail.',
      '',
      'Questions? Call {{facility.phone}}.',
    ].join('\n'),
    es: {
  ...
  // silence this rule exists to end.
  {
    ...
    bodyText: [
      ...
      '',
      'While you keep to these dates we hold off on late fees, payment notices and turning off your gate access. {{plan.grace_line}}',
      '',
