...
describe('the accessibility scan contract (B-139)', () => {
  ...
  // B-328 / SC 3.1.2 Language of Parts. The third contract in this file, and
  ...
  describe('the language-of-parts contract (B-328)', () => {
    ...
    // B-329. The staff mirror, and deliberately a DIFFERENT shape of check
