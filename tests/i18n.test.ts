...
describe('i18n dictionaries', () => {
  ...
  it('translates every field error, rather than pasting the English (B-263)', () => {
    ...
    const MUST_ALSO_DIFFER = [
      ...
      // B-310. Every `success(...)` / `fieldError(...)` literal the eight
      // `app/portal/**/actions.ts` files used to paste in English — the
      // sentence a tenant reads at the exact moment their press succeeded or
      // failed, which is `err.`'s own argument a second time under a
      // different prefix, since none of these wear the `err.` namespace.
      'acc.problem.name',
      'acc.problem.phone',
      'acc.problem.relationship',
      'acc.problem.hours',
      'acc.added',
      'acc.problem.cap',
      'acc.problem.notYourLeaseUnit',
      'acc.problem.personGone',
      'acc.problem.notYourLeasePerson',
      'acc.withdrawn',
      'acc.mobileKeyOn',
      'acc.problem.alreadyOff',
      'acc.mobileKeyOff',
      'meth.problem.unavailable',
      'meth.problem.notYours',
      'meth.problem.noMethod',
      'meth.problem.lastMethodOnAutopay',
      'meth.problem.chooseCard',
      'meth.setDefault',
      'meth.removed',
      'meth.autopayOnConfirm',
      'meth.autopayOffConfirm',
      'prot.problem.chooseUnit',
      'prot.problem.chooseLevel',
      'prot.problem.notYourLease',
      'prot.problem.alreadyCancelled',
      'prot.cancelled',
      'prot.problem.insurer',
      'prot.problem.policyNumber',
      'prot.problem.policyExpired',
      ...
      'mo.cancelled',
      'tr.requested',
      'tr.problem.nothingToCancel',
      'tr.cancelled',
      'cont.savedDetails',
      'cont.addressUpdated',
      'cont.addressUnchanged',
      'cont.problem.emailInvalid',
      'cont.problem.emailUnchanged',
      'cont.problem.emailInUse',
      ...
      'notif.marketingOn',
      'notif.marketingOff',
      'notif.problem.unrecognisedLanguage',
      'refer.inviteReady',
      'refer.problem.programDisabled',
      'refer.problem.openInviteCap',
      // B-311. The sign-in door: /login, /forgot-password, /reset-password,
      // /mfa, /reauth, /confirm-email — six routes that sat outside every
      // dictionary entirely until this row, so every key here is new rather
      // than a paste risk on an existing one. Kept in the list anyway, same
      // as B-310's portal keys: the sentence a reader meets at the exact
      // moment a press on one of these forms succeeded or failed.
      'auth.email',
      'auth.password',
      'auth.confirm',
      'auth.backToSignIn',
      'auth.problem.email',
      'auth.problem.password',
      'auth.problem.throttleOne',
      'auth.problem.throttleOther',
      'login.title',
      ...
      'login.magicLinkSummary',
      'login.magicLinkBody1',
      'login.magicLinkBody2',
      'login.magicLinkFormLabel',
      'login.magicLinkButton',
      'login.staffPrompt',
      'login.renterPrompt',
      'login.signInHere',
      'login.needHelpLead',
      'login.duringOfficeHours',
      'login.problem.staffCreds',
      'login.problem.tenantCreds',
      'login.signedIn',
      'login.magicLinkSent',
      'fpwd.title',
      'fpwd.body',
      ...
      'mfa.start.submit',
      'mfa.confirm.step1',
      'mfa.confirm.orEnterKey',
      'mfa.confirm.phoneLead',
      'mfa.confirm.phoneLink',
      'mfa.confirm.phoneTail',
      'mfa.confirm.step3',
      'mfa.confirm.formLabel',
      'mfa.confirm.codeLabel',
      'mfa.confirm.submit',
      'mfa.confirm.reassurance',
      'mfa.enrolled.body',
      'mfa.enrolled.noneLeft',
      'mfa.enrolled.remainingOne',
      'mfa.enrolled.remainingOther',
      'mfa.enrolled.formLabel',
      'mfa.enrolled.submit',
      'mfa.enrolled.warning',
      'mfa.enrolled.backToAdmin',
      'mfa.problem.alreadyOn',
      'mfa.setupStarted',
      'mfa.problem.codeRequired',
      'mfa.problem.badCode',
      ...
      'reauth.body',
      'reauth.formLabel',
      'reauth.magicLinkSummary',
      'reauth.magicLinkFormLabel',
      'reauth.problem.expired',
      'reauth.problem.incorrect',
      'reauth.confirmed',
      'reauth.magicLinkSent',
      'confemail.title',
      'confemail.success.title',
      'confemail.success.bodyAfter',
      'confemail.success.link',
      'confemail.error.title',
