...
**Next: B-368, the staff counter screens per the staff-app kit** (D-146, D-147). Read `ui_kits/staff_app/AppShell.jsx`, `TenantsScreen.jsx`, `PastDueScreen.jsx`, `UnitMapScreen.jsx` and `WalkInMoveInScreen.jsx` through `DesignSync` (project `84b81ef9-747f-4042-8f27-c32a0e41d567`). Depends on B-363 (done). The import runs through B-370, then review block 10 resumes at **B-359**.
