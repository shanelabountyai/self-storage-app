...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    //
    // B-329 / WCAG 2.1 SC 3.1.2 Language of Parts (AA). D-122 keeps the chosen
    ...
    // one shell-level declaration is true for the whole surface at once.
    //
    ...
    // B-328 solved on `/storage/[state]/[city]`.
    <div
      lang="en"
