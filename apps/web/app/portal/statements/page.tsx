            ...
            {account.months.map((month) => (
              <li key={`${month.year}-${month.month}`}>
                ...
                >
                  ...
                  <span
                    className={`font-mono tabular-nums ${month.closingBalanceCents > 0 ? 'font-medium text-danger-fg' : 'text-muted-foreground'}`}
                  >
            ...
            {group.map((statement) => (
              <li key={`${statement.year}-${statement.month}`}>
                ...
                >
                  ...
                  <span
                    className={`font-mono tabular-nums ${statement.closingBalanceCents > 0 ? 'font-medium text-danger-fg' : 'text-muted-foreground'}`}
                  >
