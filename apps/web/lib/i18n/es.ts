...
export const es: Dictionary = {
  ...
  'chrome.guides': 'Guías',
  'chrome.locations': 'Sucursales',
  'chrome.sizes': 'Tamaños',
  'chrome.sizeGuide': 'Guía de tamaños',
  'chrome.breadcrumb': 'Ruta de navegación',
  'chrome.home': 'Inicio',
  ...
  'card.from': 'desde',
  'card.perMonth': '/mes',
  'card.open': 'Oficina abierta ahora',
  'card.closed': 'Oficina cerrada ahora',
  'card.hoursToday': 'Oficina hoy: de {open} a {close}',
  'card.closedToday': 'Oficina cerrada hoy',
  'card.viewUnits': 'Ver unidades',
  'card.viewUnitsSr': 'en {name}',
  ...
  'facility.lateHeading': 'Si paga tarde / Si se muda',
  'facility.terms.rentDue': 'El alquiler vence',
  'facility.terms.dueFirst': 'El día 1 de cada mes',
  'facility.terms.dueAnniversary': 'El día de su mudanza, cada mes',
  'facility.terms.lateFee': 'Cargo por mora',
  'facility.terms.lateFeeNone': 'Sin cargo por mora',
  'facility.terms.lateFeeFlat': '{amount}, cuando el alquiler lleva {days} días vencido',
  'facility.terms.lateFeePercent': '{percent}% del saldo vencido, cuando el alquiler lleva {days} días vencido',
  'facility.terms.lateFeeGreater': 'El mayor entre {amount} o {percent}% del saldo vencido, cuando el alquiler lleva {days} días vencido',
  'facility.terms.lateFeeLesser': 'El menor entre {amount} o {percent}% del saldo vencido, cuando el alquiler lleva {days} días vencido',
  'facility.terms.gate': 'El código de acceso se pausa',
  'facility.terms.gateDay': 'A los {days} días de mora',
  'facility.terms.sold': 'Antes de vender algo',
  'facility.terms.soldWrite': 'Le escribimos primero',
  'facility.terms.notice': 'Para mudarse',
  ...
  'rcpt.date': 'Fecha',
  'rcpt.balanceOn': 'Saldo de {scope}',
  'rcpt.creditOn': 'Saldo a favor de {scope}',
  'rcpt.scopeUnit': 'la unidad {units}',
  'rcpt.scopeUnits': 'las unidades {units}',
  ...
  'mo.cause.legend': '¿Por qué se va? (obligatorio)',
  'mo.cause.price_or_rate_increase': 'El precio o un aumento de tarifa',
  'mo.cause.moved_away': 'Me mudo a otra ciudad',
  'mo.cause.no_longer_needed': 'Ya no necesito el almacenamiento',
  'mo.cause.bought_home': 'Compré una casa',
  'mo.cause.switched_facility': 'Me cambio a otro local',
  'mo.cause.service_issue': 'Un problema con el servicio o el local',
  'mo.cause.other': 'Otro motivo',
  'mo.cause.note': 'Algo que quiera añadir (opcional, hasta 200 caracteres)',
  'mo.problem.cause_required': 'Elija por qué se va.',
  'mo.problem.note_too_long': 'Limite la nota a 200 caracteres o menos.',
  ...
  'login.payLinkExpired':
    'Ese enlace de pago ha vencido. Para pagar, inicie sesión abajo. ¿No tiene contraseña? Podemos enviarle un enlace por correo. O llame al',
  'login.staffCodeHint':
