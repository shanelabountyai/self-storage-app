...
export const en = {
  ...
  'card.from': 'from',
  'card.perMonth': '/mo',
  'card.open': 'Office open now',
  'card.closed': 'Office closed now',
  'card.hoursToday': 'Office today: {open} to {close}',
  'card.closedToday': 'Office closed today',
  'card.viewUnits': 'View units',
  'card.viewUnitsSr': 'at {name}',
  ...
  'facility.lateHeading': 'If you pay late / If you leave',
  'facility.terms.rentDue': 'Rent is due',
  'facility.terms.dueFirst': 'The 1st of each month',
  'facility.terms.dueAnniversary': 'Your move-in date each month',
  'facility.terms.lateFee': 'Late fee',
  'facility.terms.lateFeeNone': 'No late fee',
  'facility.terms.lateFeeFlat': '{amount}, once rent is {days} days past due',
  'facility.terms.lateFeePercent': '{percent}% of the overdue balance, once rent is {days} days past due',
  'facility.terms.lateFeeGreater': 'The greater of {amount} or {percent}% of the overdue balance, once rent is {days} days past due',
  'facility.terms.lateFeeLesser': 'The lesser of {amount} or {percent}% of the overdue balance, once rent is {days} days past due',
  'facility.terms.gate': 'Gate code pauses',
  'facility.terms.gateDay': '{days} days past due',
  'facility.terms.sold': 'Before anything is sold',
  'facility.terms.soldWrite': 'We write to you first',
  'facility.terms.notice': 'To move out',
  ...
  'mo.cause.legend': 'Why are you leaving? (required)',
  'mo.cause.price_or_rate_increase': 'The price or a rate increase',
  'mo.cause.moved_away': "I'm moving away",
  'mo.cause.no_longer_needed': 'I no longer need the storage',
  'mo.cause.bought_home': 'I bought a home',
  'mo.cause.switched_facility': "I'm switching to another facility",
  'mo.cause.service_issue': 'A problem with the service or the facility',
  'mo.cause.other': 'Something else',
  'mo.cause.note': 'Anything you would like to add (optional, up to 200 characters)',
  'mo.problem.cause_required': 'Choose why you are leaving.',
  'mo.problem.note_too_long': 'Keep the note to 200 characters or fewer.',
  ...
  'login.payLinkExpired':
    'That payment link has expired. To pay, sign in below. No password? We can email you a sign-in link. Or call',
  'login.staffCodeHint':
