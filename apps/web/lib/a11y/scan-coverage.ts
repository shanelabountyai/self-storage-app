...
// B-328 / WCAG 2.1 SC 3.1.2 Language of Parts (AA). The third contract in this
...
export type EnglishPage = {
  ...
  /// `untranslated` is a gap somebody will close, and `mixed` (B-329) is a page
...
/// length of one merge: B-328 marked it `lang="en"` against a `main` where the
...
// B-329 / SC 3.1.2, the staff mirror of everything above. Same defect, same
...
/// the one-line half of B-329 is still there.
